...
public class ClassViewer {
    ...
    private static void showModuleName(Class clz) {
        Module m = clz.getModule(); // 取得模組代表物件
        out.printf("module %s;%n", m.getName());
    }
    
    private static void showPackageName(Class clz) {
